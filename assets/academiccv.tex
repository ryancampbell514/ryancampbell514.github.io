...
\begin{tabular}{p{0.55\linewidth}p{0.05\linewidth}p{0.40\linewidth}}
  ...
  Fylde Ave., Bailrigg, Lancaster & & \\ %\multicolumn{1}{l}{Phone:\;\;} & \multicolumn{1}{l}{$+$1 (514) 712 8670} \\
...
\begin{itemize}
  ...
  %Project Description: Using mathematical, statistical, and machine learning concepts for spatially-robust house insurance modeling.\\
  Desjardins General Insurance Group. L\'{e}vis, Qu\'{e}bec.\\
  June--December 2020 (part-time), January--June 2021 (full-time)
%  \item \textbf{Ninth Annual Industrial Problem Solving Workshop}\\
%  Centre for Mathematical Research, University of Montreal\\
%  Project Description: Using machine learning tools to automatically identify patterns and novel behaviours in the radio-frequency environment at the Dominion Radio Astrophysical Observatory\\
%  Supervisor: Chris Budd (University of Bath), Seth Siegel (McGill University)\\
%  19--23 August 2019
%  \item \textbf{Undergraduate Summer Research}\\
%  Department of Mathematics \& Statistics, McGill University.\\
%  Project: Semiparametric modeling of max-stable processing using Kendall's tau rank correlation coefficient.\\
%  Supervisor: Johanna Ne\v{s}lehov\'{a}\\
%  May--September 2018 
%  \item \textbf{Mathematics Tutor}\\
%  Private tutor for a Secondary 4 mathematics student.\\
%  2016-2017 academic year
%  \item \textbf{Manager, Lifeguard, Swimming Lessons Instructor, Diving Coach}\\
