...
\begin{tabular}{p{0.55\linewidth}p{0.05\linewidth}p{0.40\linewidth}}
  ...
  Universit\'{e} C\^{o}te d'Azur & \multicolumn{1}{l}{Email:\;\;} &\multicolumn{1}{l}{ryan.campbell@univ-cotedazur.fr} \\
   ...
   Parc Valrose, 28 Avenue Valrose, 06000 Nice & & \\ %\multicolumn{1}{l}{Phone:\;\;} & \multicolumn{1}{l}{$+$1 (514) 712 8670} \\
...
\begin{enumerate}
  ...
  \item \textbf{R. Campbell}, K Grolmusova, L. Kakampakou, and J. Lee. Analysing Extreme Rainfall via a Geometric Framework, \emph{Extremes. To appear.}
